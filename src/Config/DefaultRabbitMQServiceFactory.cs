...
namespace Microsoft.Azure.WebJobs.Extensions.RabbitMQ
{
    ...
    {
        public IRabbitMQService CreateService(string connectionString, string hostName, string exchangeName, string queueName, string userName, string password, int port)
        {
            return new RabbitMQService(connectionString, hostName, exchangeName, queueName, userName, password, port);
        }
